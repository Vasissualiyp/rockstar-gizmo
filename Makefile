...
MAKE_PATH=/gpfs/fs0/scratch/m/murray/vasissua/PeakPatch/ROCKSTAR/rockstar
CFLAGS += -I$(MAKE_PATH)/libtirpc-devel/usr/include 
LDFLAGS=-shared
OFLAGS += -ltirpc
