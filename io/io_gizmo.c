...
{	
  ...
  //Om = gizmo_readheader_float(HDF_Header, filename, "Omega0");
  //h0 = gizmo_readheader_float(HDF_Header, filename, "HubbleParam");
  //SCALE_NOW = gizmo_readheader_float(HDF_Header, filename, "Time");
  //BOX_SIZE = gizmo_readheader_float(HDF_Header, filename, "BoxSize");
  //BOX_SIZE *= GIZMO_LENGTH_CONVERSION;  
