...
integer(GIZMO_ID_BYTES, 8);
real(GIZMO_MASS_CONVERSION, 1e10);
real(GIZMO_LENGTH_CONVERSION, 1e-3);
integer(GIZMO_DM_PARTTYPE, 1);

integer(GIZMO_OLD_ID_BYTES, 8);
real(GIZMO_OLD_MASS_CONVERSION, 1e10);
real(GIZMO_OLD_LENGTH_CONVERSION, 1e-3);
integer(GIZMO_OLD_DM_PARTTYPE, 1);
#endif /* ENABLE_HDF5 */
